...
KNOWN_COMMANDS="audit-code audit-project audit-docs diagnose refactor-plan generate-tests generate-docs implement parallel-review test-system reflect repair-docs"
