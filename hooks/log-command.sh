...
KNOWN_COMMANDS="audit-code audit-naming audit-project audit-docs diagnose refactor-plan generate-tests generate-docs implement parallel-review reflect repair-docs"
