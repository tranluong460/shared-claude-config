...
paths:
  - src/**
description: 4-step analysis process before implementing logic changes
---
...
Step 1: Input Assumptions --> Step 2: Flow Analysis --> Step 3: Report --> Step 4: Implement
        (Giả định dữ liệu)    (Phân tích flow)         (Báo cáo)         (Thực thi)
```
...
## Step 1: Input Assumptions (Giả định dữ liệu)
...
## Step 2: Original Flow Analysis (Phân tích flow)
...
## Step 3: Detailed Report (Báo cáo phân tích chi tiết)
...
## Step 4: Implementation (Thực thi)
